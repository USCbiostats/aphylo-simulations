...
# Reading true data
true_annotations <- data.table::fread(
  file = "data-raw/inferred_annotations",
  sep="\t", header = FALSE
  )

colnames(true_annotations) <- c("substring", "primary_ext_acc", "term", "qualifier")
...
# Saving
readr::write_csv(candidate_functions, path = "data/candidate_functions_inferred.csv")
