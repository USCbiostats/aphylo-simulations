...
#SBATCH --mem=12GB
#SBATCH --job-name=parameter_estimates-new
...
saveRDS(
  ...
  "parameter_estimates_mle_fully_annotated_no_prior-new.rds"
  )
...
saveRDS(
  ...
  "mcmc_fully_annotated_no_prior-new.rds"
  )
# 1.B: Prior
...
saveRDS(
  ...
  "mle_fully_annotated_prior-new.rds"
  )
...
saveRDS(
  ...
  "mcmc_fully_annotated_prior-new.rds"
  )
...
saveRDS(
  ...
  "mle_partially_annotated_no_prior-new.rds"
  )
mcmc.$kernel <- fmcmc::kernel_ram(lb = lb., ub = ub., warmup = warmup., freq = freq.)
...
saveRDS(
  ...
  "mcmc_partially_annotated_no_prior-new.rds"
  )
# 1.B: Prior
...
saveRDS(
  ...
  "mle_partially_annotated_prior-new.rds"
  )
mcmc.$kernel <- fmcmc::kernel_ram(lb = lb., ub = ub., warmup = warmup., freq = freq.)
...
saveRDS(
  ...
  "mcmc_partially_annotated_prior-new.rds"
  )
