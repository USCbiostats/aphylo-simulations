...
load("simulations/04_uniform_sim/mcmc_right_prior_estimates.rda")
...
saveRDS(pred_scores, file = "simulations/04_uniform_sim/mcmc_right_prior_prediction.rds", compress = FALSE)
...
graphics.off()
pdf("simulations/04_uniform_sim/mcmc_right_prior_prediction.pdf")
