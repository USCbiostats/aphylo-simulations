...
saveRDS(pred_scores, file = "simulations/02-gold-standard/mcmc_wrong_prior_prediction.rds", compress = FALSE)
...
graphics.off()
pdf("simulations/02-gold-standard/mcmc_wrong_prior_prediction.pdf")
