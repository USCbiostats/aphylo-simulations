...
saveRDS(pred_scores, file = "simulations/03_uniform_drop_of_0/mcmc_wrong_prior_prediction.rds", compress = FALSE)
...
graphics.off()
pdf("simulations/03_uniform_drop_of_0/mcmc_wrong_prior_prediction.pdf")
