...
bias_MCMC_right <- bias_calc("simulations/01-informative-force/mcmc_right_prior_estimates.rda", "ans_MCMC_right_prior")
bias_MCMC_wrong <- bias_calc("simulations/01-informative-force/mcmc_wrong_prior_estimates.rda", "ans_MCMC_wrong_prior")
...
save(bias, file = "simulations/01-informative-force/bias.rda")
