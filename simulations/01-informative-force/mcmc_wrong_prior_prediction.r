...
load("simulations/01-informative-force/mcmc_wrong_prior_estimates.rda")
...
saveRDS(pred_scores, file = "simulations/01-informative-force/mcmc_wrong_prior_prediction.rds", compress = FALSE)
...
graphics.off()
pdf("simulations/01-informative-force/mcmc_wrong_prior_prediction.pdf")
