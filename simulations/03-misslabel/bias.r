...
# Computing bias ---------------------------------------------------------------
bias_MCMC_right <- bias_calc("simulations/03-misslabel/mcmc_right_prior_estimates.rds", dat)
bias_MCMC_wrong <- bias_calc("simulations/03-misslabel/mcmc_wrong_prior_estimates.rds", dat)
