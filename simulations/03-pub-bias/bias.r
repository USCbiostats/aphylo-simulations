...
bias_MCMC_right <- bias_calc("simulations/03-pub-bias/mcmc_right_prior_estimates.rds", "ans_MCMC_right_prior")
bias_MCMC_wrong <- bias_calc("simulations/03-pub-bias/mcmc_wrong_prior_estimates.rds", "ans_MCMC_wrong_prior")
