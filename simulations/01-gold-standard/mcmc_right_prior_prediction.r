...
saveRDS(pred_scores, file = "simulations/01-gold-standard/mcmc_right_prior_prediction.rds", compress = FALSE)
...
graphics.off()
pdf("simulations/01-gold-standard/mcmc_right_prior_prediction.pdf")
