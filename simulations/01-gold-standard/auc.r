...
pred_right <- readRDS("simulations/01-gold-standard/mcmc_right_prior_prediction.rds")
pred_wrong <- readRDS("simulations/01-gold-standard/mcmc_wrong_prior_prediction.rds")
...
ans %>%
  ...
  ggsave("simulations/01-gold-standard/auc.pdf", device = "pdf", width=6, height=6)
