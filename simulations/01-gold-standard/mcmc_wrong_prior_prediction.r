...
ans_MCMC_wrong_prior <- readRDS("simulations/01-gold-standard/mcmc_wrong_prior_estimates.rds")
...
saveRDS(pred_scores, file = "simulations/01-gold-standard/mcmc_wrong_prior_prediction.rds", compress = FALSE)
...
graphics.off()
pdf("simulations/01-gold-standard/mcmc_wrong_prior_prediction.pdf")
