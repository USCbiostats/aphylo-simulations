...
pred_right <- readRDS("simulations/02-missing/mcmc_right_prior_prediction.rds")
pred_wrong <- readRDS("simulations/02-missing/mcmc_wrong_prior_prediction.rds")
...
ans %>%
  ...
  ggsave("simulations/02-missing/auc.pdf", device = "pdf", width=6, height=6)
