...
saveRDS(pred_scores, file = "simulations/04-full-model/mcmc_wrong_prior_prediction.rds", compress = FALSE)
...
graphics.off()
pdf("simulations/04-full-model/mcmc_wrong_prior_prediction.pdf")
